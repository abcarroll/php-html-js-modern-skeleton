...
table of contents](docs/html5-boilerplate/TOC.md)
...
CSS](docs/html5-boilerplate/css.md).
...
get you started. [About the JavaScript](docs/html5-boilerplate/js.md).
...
editors and IDEs. [Read more about the `.editorconfig` file](docs/html5-boilerplate/misc.md#editorconfig).
...
refer to the [according documentation](docs/html5-boilerplate/extend.md#apple-touch-icons).
